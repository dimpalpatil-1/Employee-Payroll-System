...
class EmployeeSystem:
    def __init__(self,root):
        self.root = root
        self.root.title("Employee Payroll Management System | Developed by Dimple Wagh")
        ...
        self.text_code=Entry(Frame1,font=("times new roman",15),textvariable=self.var_emp_code,bg="lightyellow",fg="black")
        self.text_code.place(x=220,y=75,width=200)
        btn_search=Button(Frame1,text="Search",command=self.search,font=("times new roman",20),bg="gray",fg="black").place(x=440,y=70,height=30)
        
        #==========Row1
        lbl_designation=Label(Frame1,text="Desgnation",font=("times new roman",20),bg="white",fg="black").place(x=10,y=120)
        text_designation=Entry(Frame1,font=("times new roman",15),textvariable=self.var_designation,bg="lightyellow",fg="black").place(x=170,y=120,width=200)
        lbl_dob=Label(Frame1,text="D.O.B.",font=("times new roman",20),bg="white",fg="black").place(x=390,y=120)
        text_dob=Entry(Frame1,font=("times new roman",15),textvariable=self.var_dob,bg="lightyellow",fg="black").place(x=520,y=125)

        #==========Row2
        lbl_name=Label(Frame1,text="Name",font=("times new roman",20),bg="white",fg="black").place(x=10,y=170)
        text_name=Entry(Frame1,font=("times new roman",15),textvariable=self.var_name,bg="lightyellow",fg="black").place(x=170,y=170,width=200)
        lbl_doj=Label(Frame1,text="D.O.J.",font=("times new roman",20),bg="white",fg="black").place(x=390,y=170)
        text_doj=Entry(Frame1,font=("times new roman",15),textvariable=self.var_doj,bg="lightyellow",fg="black").place(x=520,y=170)

        #==========Row3
        lbl_Age=Label(Frame1,text="Age",font=("times new roman",20),bg="white",fg="black").place(x=10,y=220)
        text_age=Entry(Frame1,font=("times new roman",15),textvariable=self.var_age,bg="lightyellow",fg="black").place(x=170,y=220,width=200)
        lbl_experience=Label(Frame1,text="Experience",font=("times new roman",20),bg="white",fg="black").place(x=390,y=220)
        text_exeperiance=Entry(Frame1,font=("times new roman",15),textvariable=self.var_experience,bg="lightyellow",fg="black").place(x=520,y=220)

        #==========Row4
        lbl_gender=Label(Frame1,text="Gender",font=("times new roman",20),bg="white",fg="black").place(x=10,y=270)
        text_gender=Entry(Frame1,font=("times new roman",15),textvariable=self.var_gender,bg="lightyellow",fg="black").place(x=170,y=270,width=200)
        lbl_proof=Label(Frame1,text="Proof ID",font=("times new roman",20),bg="white",fg="black").place(x=390,y=270)
        text_proof=Entry(Frame1,font=("times new roman",15),textvariable=self.var_proof_id,bg="lightyellow",fg="black").place(x=520,y=270)

        #==========Row5
        lbl_email=Label(Frame1,text="Email",font=("times new roman",20),bg="white",fg="black").place(x=10,y=320)
        text_email=Entry(Frame1,font=("times new roman",15),textvariable=self.var_email,bg="lightyellow",fg="black").place(x=170,y=320,width=200)
        lbl_contact=Label(Frame1,text="Contact",font=("times new roman",20),bg="white",fg="black").place(x=390,y=320)
        text_contact=Entry(Frame1,font=("times new roman",15),textvariable=self.var_contact,bg="lightyellow",fg="black").place(x=520,y=320)

        #==========Row6
        lbl_hired=Label(Frame1,text="Hired Location",font=("times new roman",18),bg="white",fg="black").place(x=10,y=370)
        text_hired=Entry(Frame1,font=("times new roman",15),textvariable=self.var_hr_location,bg="lightyellow",fg="black").place(x=170,y=370,width=200)
        lbl_status=Label(Frame1,text="Status",font=("times new roman",20),bg="white",fg="black").place(x=390,y=370)
        text_status=Entry(Frame1,font=("times new roman",15),textvariable=self.var_status,bg="lightyellow",fg="black").place(x=520,y=370)

        #==========Row7
        lbl_address=Label(Frame1,text="Address",font=("times new roman",18),bg="white",fg="black").place(x=10,y=420)
        self.text_address=Text(Frame1,font=("times new roman",15),bg="lightyellow",fg="black")
        self.text_address.place(x=170,y=420,width=550,height=150)
        ...
        Frame2.place(x=770,y=70,width=550,height=300)
        ...
        #==========Row1
        lbl_month=Label(Frame2,text="Month",font=("times new roman",18),bg="white",fg="black").place(x=10,y=50)
        text_month=Entry(Frame2,font=("times new roman",15),textvariable=self.var_month,bg="lightyellow",fg="black").place(x=90,y=50,width=100)

        lbl_year=Label(Frame2,text="Year",font=("times new roman",18),bg="white",fg="black").place(x=200,y=50)
        text_year=Entry(Frame2,font=("times new roman",15),textvariable=self.var_year,bg="lightyellow",fg="black").place(x=260,y=50,width=90)

        lbl_salary=Label(Frame2,text="Salary",font=("times new roman",18),bg="white",fg="black").place(x=360,y=50)
        text_salary=Entry(Frame2,font=("times new roman",15),textvariable=self.var_salary,bg="lightyellow",fg="black").place(x=430,y=50,width=100)
        
        #==========Row2
        lbl_days=Label(Frame2,text="Total Days",font=("times new roman",18),bg="white",fg="black").place(x=10,y=100)
        text_days=Entry(Frame2,font=("times new roman",15),textvariable=self.var_t_days,bg="lightyellow",fg="black").place(x=130,y=100,width=115)
        lbl_absent=Label(Frame2,text="Absents",font=("times new roman",18),bg="white",fg="black").place(x=260,y=100)
        text_absent=Entry(Frame2,font=("times new roman",15),textvariable=self.var_absent,bg="lightyellow",fg="black").place(x=370,y=100,width=115)

       #==========Row3
        lbl_medical=Label(Frame2,text="Medical",font=("times new roman",18),bg="white",fg="black").place(x=10,y=150)
        text_medical=Entry(Frame2,font=("times new roman",15),textvariable=self.var_medical,bg="lightyellow",fg="black").place(x=130,y=150,width=115)
        lbl_pf=Label(Frame2,text="PF",font=("times new roman",18),bg="white",fg="black").place(x=260,y=150)
        text_pf=Entry(Frame2,font=("times new roman",15),textvariable=self.var_pf,bg="lightyellow",fg="black").place(x=370,y=150,width=115)

        #==========Row4
        lbl_convence=Label(Frame2,text="Convence",font=("times new roman",18),bg="white",fg="black").place(x=10,y=200)
        text_convence=Entry(Frame2,font=("times new roman",15),textvariable=self.var_convence,bg="lightyellow",fg="black").place(x=130,y=200,width=115)
        lbl_netsalary=Label(Frame2,text="Net Salary",font=("times new roman",18),bg="white",fg="black").place(x=260,y=200)
        text_netsalary=Entry(Frame2,font=("times new roman",15),textvariable=self.var_net_salary,bg="lightyellow",fg="black").place(x=370,y=200,width=115)

        btn_calculate=Button(Frame2,text="Calculate",command=self.calculate,font=("times new roman",16),bg="orange",fg="black").place(x=10,y=235,height=25,width=100)
        self.btn_save=Button(Frame2,text="Save",command=self.add,font=("times new roman",16),bg="green",fg="black")
        self.btn_save.place(x=180,y=235,height=25,width=100)
        btn_clear=Button(Frame2,text="Clear",command=self.clear,font=("times new roman",16),bg="lightcoral",fg="black").place(x=340,y=235,height=25,width=100)
        
        self.btn_update=Button(Frame2,text="Update",state=DISABLED,command=self.update,font=("times new roman",16),bg="blue",fg="black")
        self.btn_update.place(x=10,y=265,height=25,width=100)
        self.btn_delete=Button(Frame2,text="Delete",state=DISABLED,command=self.delete,font=("times new roman",16),bg="red",fg="black")
        self.btn_delete.place(x=180,y=265,height=25,width=100)
        

        #===========Frame3=============
        Frame3=Frame(self.root,bd=3,relief=RIDGE,bg="white")
        Frame3.place(x=770,y=380,width=550,height=310)
        ...
        sal_Frame.place(x=251,y=2,width=292,height=300)
        title_sal=Label(sal_Frame,text="Salary Receipt",font=("times new roman",18),bg="lightgray",fg="black",anchor="w",padx=10).place(x=0,y=0,relwidth=1)

        sal_Frame2=Frame(sal_Frame,bg='white',bd=2,relief=RIDGE)
        sal_Frame2.place(x=0,y=30,relwidth=1,height=265)

        self.sample=f"""\tCompany Name, XYZ\n\tAddress: Xyz, Floor4
-------------------------------------------
Employee ID\t\t:    
Salary Of\t\t:    Month-YYYY
...
Net Salary\t\t:    Rs.
-------------------------------------------
This is computer generated slip, does not required any signature
...
"""
        ...
        btn_print=Button(Frame2,text="Print",command=self.print,font=("times new roman",16),bg="darkturquoise",fg="black").place(x=340,y=265,height=25,width=100)
        ...
        if self.var_emp_code.get()=='' or self.var_net_salary.get()=='' or self.var_name.get()=='':
            ...
            try:
                ...
                if row!=None:
                    ...
                    cur.execute("insert into emp_salary value(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                    (
...
"""
    ...
    def employee_frame(self):
        ...
        self.root2.title("Employee Payroll Management System | Developed by Dimple Wagh")
        self.root2.geometry("1000x500+120+100")
        self.root2.config(bg="white")
        title=Label(self.root2,text="All Employee Details",font=("times new roman",28,"bold"),bg="#262626",fg="white",anchor="w",padx=10).pack(side=TOP,fill=X)
        ...
        self.employee_tree.heading( 'experience',text='Experiece')
